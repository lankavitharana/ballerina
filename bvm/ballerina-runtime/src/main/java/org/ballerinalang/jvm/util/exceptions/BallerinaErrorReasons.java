...
public class BallerinaErrorReasons {
    ...
    public static final StringValue TYPE_CAST_ERROR = new StringValue(BALLERINA_PREFIX.concat("TypeCastError"));
    public static final StringValue NUMBER_CONVERSION_ERROR =
            new StringValue(BALLERINA_PREFIX.concat("NumberConversionError"));
    public static final StringValue JSON_OPERATION_ERROR =
            new StringValue(BALLERINA_PREFIX.concat("JSONOperationError"));
    ...
    public static final StringValue BALLERINA_PREFIXED_CONVERSION_ERROR =
            new StringValue(BALLERINA_PREFIX.concat("ConversionError"));
    ...
    public static final StringValue JSON_CONVERSION_ERROR =
            new StringValue(BALLERINA_PREFIX.concat("JSONConversionError"));
    public static final String XML_CREATION_ERROR = BALLERINA_PREFIX.concat("XMLCreationError");
    public static final StringValue STACK_OVERFLOW_ERROR = new StringValue(BALLERINA_PREFIX.concat("StackOverflow"));
    ...
    public static final StringValue MERGE_JSON_ERROR =
            new StringValue(getModulePrefixedReason(VALUE_LANG_LIB, "MergeJsonError"));
    public static final String STRING_OPERATION_ERROR = getModulePrefixedReason(STRING_LANG_LIB,
                                                                                "StringOperationError");
    public static final StringValue XML_OPERATION_ERROR =
            new StringValue(getModulePrefixedReason(XML_LANG_LIB, "XMLOperationError"));
    public static final StringValue MAP_KEY_NOT_FOUND_ERROR = new StringValue(getModulePrefixedReason(MAP_LANG_LIB,
    ...
    public static final StringValue FUTURE_CANCELLED =
            new StringValue(getModulePrefixedReason(FUTURE_LANG_LIB, "FutureAlreadyCancelled"));
